...
first_student = Student("Круз", "Кастильо", "м")
first_student.finished_courses += ["Бейсик"]
first_student.courses_in_progress += ["GIT"]
first_student.courses_in_progress += ["Python"]

second_student = Student("Гарри", "Трумен", "м")
second_student.courses_in_progress += ["Python"]
second_student.finished_courses += ["Фортран"]

first_lecturer = Lecturer("Сиси", "Кэпвелл")
first_lecturer.courses_attached += ["Python"]
first_lecturer.courses_attached += ["GIT"]

second_lecturer = Lecturer("Дейл", "Купер")
second_lecturer.courses_attached += ["GIT"]

first_reviewer = Reviewer("Оби-Ван", "Кеноби")
first_reviewer.courses_attached += ["Python"]

second_reviewer = Reviewer("Люк", "Скайуокер")
...
print(f"Средняя оценка за д.з. у Круза Кастильо больше, чем у Гарри Трумена {second_student < first_student}")
print(f"Средняя оценка за лекции у Дейла Купера меньше, чем у Сиси Кэпвелла {second_lecturer < first_lecturer}\n")
